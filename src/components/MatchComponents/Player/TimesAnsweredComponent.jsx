...
const TimesAnsweredComponent = ({ clickedResponses, response }) => {
    return (
        <div className=" m-0 relative top-6 sm:left-5 left-40 gap-1 bg-black text-[--yellow] flex items-center  p-2 w-10 h-10 rounded-full">
            <span>
